function testeValidSocial() {
  ...
  let expressaoGitHub = new RegExp("http(s)?:\/\/github\.com\/[A-z0-9_-]+\/?")
  ...
  setInterval((correct == 2 ? submitSocial.classList.remove('btn-danger') : submitSocial.classList.add('btn-danger')),1000)
  correct == 2 ? (flagPage = 3) : (flagPage = 2)
  correct == 2 ? basicCorrect() : console.log('ha ' + (correct - 2 + ' erros'))
  pagination()
}